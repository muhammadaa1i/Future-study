...
const Home = () => {
    return (
        <div className="main-content max-w-7xl w-full mx-auto px-4 py-8 text-[#004D91]">
            <section className="flex flex-col items-start max-sm:mb-[-10px]">
                <div className="bg-[#004D91] h-[2px] max-w-[170px] md:max-w-[220px] md:h-[3px] w-full rounded-lg"></div>
            ...
            <section className="flex flex-col items-start mt-8 max-sm:mb-[-10px]">
                <div className="bg-[#004D91] h-[2px] max-w-[200px] md:max-w-[220px] md:h-[3px] w-full rounded-lg lg:max-w-[260px]"></div>
            ...
            <section className='bg-[#004D91] w-full h-auto py-10 px-5 rounded-2xl m-auto mt-8 flex flex-col gap-8 min-[320px]:w-[90%] min-[400px]:w-[80%] min-[450px]:w-full min-[450px]:grid min-[450px]:gap-8 min-[450px]:grid-cols-2 md:flex md:justify-between md:flex-row md:px-8'>
            ...
            <section className="flex flex-col items-start mt-8 max-sm:mb-[-10px]">
                <div className="bg-[#004D91] h-[2px] max-w-[200px] md:max-w-[250px] md:h-[3px] w-full rounded-lg lg:max-w-[260px]"></div>
            ...
            <section
                ...
                className='w-[70vw] h-[60vh] max-[350px]:h-[70vh] m-auto mt-8 text-white text-center pt-6 flex flex-col rounded-4xl px-2 min-[450px]:h-[50vh] min-[450px]:pt-10'>
                <h2 className='font-medium text-xl max-[450px]:text-[14px]'>
                    Chet elda ta'lim dasturlari bilan
                </h2>
                <h1 className='text-4xl font-medium max-[450px]:text-3xl'>
                    Sizni dunyo bilan bog'laydi!
                </h1>
                <div className='flex flex-col mt-6 justify-center gap-2 min-[450px]:flex-row min-[450px]:justify-evenly min-[450px]:pl-5 sm:mt-10'>
                    <span className='flex flex-col'>
                        <h3 className='text-2xl font-semibold sm:text-3xl'>250+</h3>
                        <p className='text-[12px] mr-3 sm:text-[16px]'>Talaba</p>
                    </span>
                    <span>
                        <h3 className='text-2xl font-semibold sm:text-3xl'>6+</h3>
                        <p className='text-[12px] sm:text-[16px]'>Tajriba</p>
                    </span>
                    <span>
                        <h3 className='text-2xl font-semibold sm:text-3xl'>23+</h3>
            ...
            <section className="flex flex-col items-start mt-8 max-sm:mb-[-10px]">
                <div className="bg-[#004D91] h-[2px] max-w-[250px] md:max-w-[300px] md:h-[3px] w-full rounded-lg lg:max-w-[310px]"></div>
