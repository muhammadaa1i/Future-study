    ...
    return (
        <div className="main-content max-w-7xl w-full mx-auto px-4 py-8 text-[#004D91]">
            ...
            <div className='flex max-[550px]:flex-col gap-6 flex-row justify-between'>
                ...
                {/* {isLoading && (
                    <img
                        src={poster}
                        alt="Loading..."
                        className="absolute inset-0 w-full h-full object-cover animate-pulse rounded-2xl"
                    />
                )} */}
                <video controls
                    poster={poster}
            ...
            <section
                ...
                <div className='flex flex-col mt-6 justify-center gap-2 min-[450px]:flex-row min-[450px]:justify-evenly min-[450px]:pl-5 sm:mt-10 min-[450px]:mt-12'>
                    <span className='flex flex-col'>
                        <h3 className='text-2xl font-semibold sm:text-3xl'>
                            <TypeAnimation
                                sequence={[
                                    ...Array(251).keys()].slice(1).flatMap(num => [num + "+", 50])}
                                speed={50}
                                cursor={false}
                                repeat={0} />
                        </h3>
                    ...
                    <span>
                        <h3 className='text-2xl font-semibold sm:text-3xl'>
                            <TypeAnimation
                                sequence={[
                                    ...Array(7).keys()].slice(1).flatMap(num => [num + "+", 100])}
                                speed={100}
                                cursor={false}
                                repeat={0} />
                        </h3>
                    ...
                    <span>
                        <h3 className='text-2xl font-semibold sm:text-3xl'>
                            <TypeAnimation
                                sequence={[
                                    ...Array(24).keys()].slice(1).flatMap(num => [num + "+", 80])}
                                speed={80}
                                cursor={false}
                                repeat={0} />
                        </h3>
